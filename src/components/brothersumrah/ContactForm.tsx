...
const ContactForm = () => {
  ...
  // Handle input changes - Fixed to ensure this works properly
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
              ...
              <div>
                <div className="mb-6 flex flex-col md:flex-row md:items-center md:gap-4">
                  <h2 className="heading-md text-umrah-darkPurple mb-4 md:mb-0">
                    Ready to Join Us?
                  </h2>
                  <a
                    href={stripeLink}
                    ...
                    className="bg-umrah-gold text-umrah-darkPurple inline-block rounded-md px-6 py-3 font-bold uppercase shadow-md transition-all hover:bg-opacity-90 hover:shadow-lg"
                  >
                    RESERVE YOUR SPOT
                  </a>
                </div>
                ...
                <div className="mb-6 space-y-4">
                  <div className="flex items-center">
                    <div className="bg-umrah-purple/10 mr-4 flex h-10 w-10 items-center justify-center rounded-full">
                      <svg
              ...
              <div>
                ...
                >
                  ...
                  <div className="space-y-4">
                    ...
                    <button
                      type="submit"
                      className="bg-umrah-purple hover:bg-umrah-darkPurple w-full rounded-md px-4 py-2 text-white transition-colors"
