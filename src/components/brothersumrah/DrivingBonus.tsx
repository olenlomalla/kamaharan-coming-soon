...
const FeatureBox = ({ icon: Icon, title, description }) => (
  <div className="flex flex-col items-center gap-4 md:flex-row md:items-start">
    ...
    <div>
      <h3 className="text-umrah-gold mb-2 text-center text-lg font-semibold md:text-left">
        {title}
      </h3>
...
const DrivingBonus = () => {
  return (
    <section className="relative overflow-hidden py-20">
      ...
      <div className="bg-umrah-darkPurple/80 absolute inset-0 z-0" />
      ...
      <div className="container relative z-10 mx-auto px-4">
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
          <div>
            ...
            <div className="bg-umrah-purple/40 border-umrah-gold/30 mb-8 rounded-lg border p-6">
              <h3 className="text-umrah-gold mb-2 text-xl font-bold">
