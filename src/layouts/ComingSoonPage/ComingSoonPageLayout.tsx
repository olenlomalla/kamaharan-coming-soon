    ...
    <FullScreenContainer>
      <div className="relative z-10 flex min-h-[100svh] w-full flex-col justify-end">
        ...
        <div className="flex w-full flex-col items-center md:hidden">
          ...
          <div className="flex h-[60vh] w-full flex-col items-center justify-between px-4 py-8 landscape:hidden">
            ...
            <div className="mb-8 flex flex-col items-center gap-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="safe-bottom rounded bg-red-600 px-6 py-2 text-sm font-medium text-white transition-colors hover:bg-red-700"
              >
                REQUEST INVITE
              </a>
            </div>
          ...
          {/* Landscape */}
          <div className="safe-left safe-right flex w-full items-center justify-between px-6 py-4 portrait:hidden">
            ...
            <div className="safe-right flex w-1/3 justify-end">
              <img
                src="/icons/logo-white.svg"
                alt="Kamaharan Logo"
